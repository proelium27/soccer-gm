...
function makeSquad(pidOffset = 0): MatchPlayer[] {
  return [
    { pid: pidOffset + 1, pos: "GK", shooting: 10, dribbling: 10, tackling: 10, keeping: 80, positioning: 50, heading: 40 },
    { pid: pidOffset + 2, pos: "CB", shooting: 20, dribbling: 30, tackling: 75, keeping: 5, positioning: 70, heading: 65 },
    { pid: pidOffset + 3, pos: "CB", shooting: 15, dribbling: 25, tackling: 72, keeping: 5, positioning: 68, heading: 60 },
    { pid: pidOffset + 4, pos: "FB", shooting: 25, dribbling: 50, tackling: 60, keeping: 5, positioning: 55, heading: 40 },
    { pid: pidOffset + 5, pos: "FB", shooting: 30, dribbling: 55, tackling: 58, keeping: 5, positioning: 52, heading: 38 },
    { pid: pidOffset + 6, pos: "DM", shooting: 35, dribbling: 45, tackling: 70, keeping: 5, positioning: 65, heading: 50 },
    { pid: pidOffset + 7, pos: "CM", shooting: 50, dribbling: 60, tackling: 50, keeping: 5, positioning: 60, heading: 45 },
    { pid: pidOffset + 8, pos: "CM", shooting: 55, dribbling: 62, tackling: 48, keeping: 5, positioning: 58, heading: 42 },
    { pid: pidOffset + 9, pos: "W", shooting: 65, dribbling: 75, tackling: 25, keeping: 5, positioning: 55, heading: 35 },
    { pid: pidOffset + 10, pos: "W", shooting: 60, dribbling: 70, tackling: 28, keeping: 5, positioning: 53, heading: 33 },
    { pid: pidOffset + 11, pos: "ST", shooting: 82, dribbling: 65, tackling: 15, keeping: 5, positioning: 60, heading: 55 },
  ];
}
