...
export function computeRecordBook(league: LeagueStore, limit = RECORD_LIST_LIMIT): RecordBook {
  ...
  return {
    ...
    seasonGoals: topBy(careers, (c) => c.bestGoals, limit),
    seasonAssists: topBy(careers, (c) => c.bestAssists, limit),
    careerGoals: topBy(careers, (c) => c.goals, limit),
    careerAppearances: topBy(careers, (c) => c.appearances, limit),
    careerAssists: topBy(careers, (c) => c.assists, limit),
