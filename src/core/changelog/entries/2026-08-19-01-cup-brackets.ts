...
const entry: ChangelogEntry = {
  ...
  items: [
    "The Continental Cup is a real bracket: its quarter-final winners feed known semi-final slots, so a tie now sits between the two ties that feed it, with lines joining them up. The domestic cup isn't a bracket at all. Its survivors go back in the hat every round and nothing feeds anything, so it gets dense columns of results instead. I had been drawing both the same way, which made one of them look like something it isn't.",
