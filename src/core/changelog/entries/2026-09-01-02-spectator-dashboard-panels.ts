...
const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "Spectator saves get all of it as well, which is really what prompted this. Watching a world without a club of your own is a lot better when you can see who's rising and how the cups are going without leaving the page.",
  ],
};
