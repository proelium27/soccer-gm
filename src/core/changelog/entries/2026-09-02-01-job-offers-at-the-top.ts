...
const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "National teams had the identical bug and got the identical fix.",
    "There was a second thing wrong on the international side, and it only showed up once I went looking. Your international reputation starts at 30 and the only way to raise it is to hold a national job, so a club manager who has never had one sits on 30 forever. Federations couldn't see your club career at all, which meant that on a 70-nation world the best country that could ever be offered to you was ranked 33rd. You could win five league titles and a Champions League and still only ever hear from the bottom half of the world.",
    "Federations can now see your club record, heavily discounted. A full trophy cabinet gets you to around 18th in the world, roughly Wales or Serbia, and it starts counting once your club reputation is up near the high 40s, which is about a league title. The giants stay where they were: Spain, Brazil and the rest still want an international reputation you can only build in the job, so the route to them is still to take a smaller country first and do something with it.",
