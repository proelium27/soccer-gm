...
const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "Winning a round pays, and it pays more the further you go, though a full run is worth well under a Continental Cup run. The money scales to your country's economy like the rest of your income, so a Turkish cup run doesn't pay an English cheque.",
