...
const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "The club **borrowing** your player was also the one deciding whether to renew him. Your own club got no say, and since he doesn't appear on your Roster page while he's away, you had no way to extend him yourself. He'd run his deal down at somebody else's club and leave for free the moment he got home.",
    ...
    "If you're carrying an affected save, players already sitting on dead contracts get sorted out at your next offseason, and sorted out means released. If one of them is someone you want, extend him before you advance.",
  ],
};
