...
const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "The score is broken out across the table the way the GOAT board breaks it out: what his peak was worth, what the years he held it were worth, then his awards and his trophies. Click any row for the full arithmetic behind those.",
