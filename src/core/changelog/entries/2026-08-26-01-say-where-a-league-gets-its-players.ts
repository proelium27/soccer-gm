...
const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "Every nation also has far more names to draw on, because a nation that used to supply a handful of foreign players in someone else's league can now be a whole league of its own. A pool of 24 first and 24 last names covers 576 possible names, and across the ~1000 players a two-division league holds, 82% of them shared a name with someone and one name turned up six times over. Pools now start at 56 of each, the file carries about 16,000 names in total, and the worst case is down to a name appearing three times.",
