...
const entry: ChangelogEntry = {
  ...
  items: [
    "Cards have been in the match engine for a long time, but they stopped mattering the moment the whistle went. Now they follow a player around. Five yellows across the league season and he misses the next match. Sent off for a second yellow, he misses one. Straight red, he misses three.",
    "If a sending-off and your fifth yellow happen to land in the same game, he serves the longer of the two rather than both. Stacking them is more true to life, but it felt like a pile-on for something you have no say in, and the difference was one match.",
