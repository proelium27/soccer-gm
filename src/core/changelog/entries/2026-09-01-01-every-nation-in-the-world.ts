...
const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "Each of the new 101 gets a pool of its own: 56 first names and 56 surnames, so about three thousand combinations, the same size as the ones already in the game. They're ordinary civilian names, never real footballers'.",
