...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "\"Export Teams\" has been replaced by \"Export Save\", which downloads the entire save — every club, player, stat and transfer — rather than a list of club names. \"Import Save\" at the bottom of the Leagues screen loads one back. Together they cover backing a league up, moving it between computers, and handing it to someone else to continue. Note this is a snapshot of a save, not an editable roster file: it isn't meant to be hand-edited and can't seed a fresh league. To author a roster file, use the \"Copy AI Prompt to Customize\" button in the top bar of any save.",
