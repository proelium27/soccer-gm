...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      "The Match Rating leaderboard was getting cluttered with guys who only played a game or two. Match Rating is an average, so if someone came off the bench once and had a blinder, his one great score would rocket him to the top of the chart above players who'd been great all season. That's silly, so now you need to have played at least a third of the games so far to show up on the Match Rating boards (both the full Stat Leaders page and the little leaders box on the Dashboard). I made it a third of games played rather than a flat number on purpose, so it still works ten games into a season instead of only making sense at the very end. Every other stat, like goals and assists, is a running total so it's unaffected.",
    ],
  },
  {
    date: "2026-07-20",
