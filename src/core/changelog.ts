...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      "Someone spotted that signing a player handed him every league title the club had ever won, including ones from before he was born. A 19-year-old could come out of the academy with five trophies on his profile. Embarrassing.",
