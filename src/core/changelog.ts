...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Hovering a season used to show the club and the OVR. It now opens a card with his value that season, his OVR and POT, his goals and assists, his appearances, and the club, with a season he spent in a youth academy marked as such. A season he was in the squad for but never played reads as a dash rather than as zero goals.",
