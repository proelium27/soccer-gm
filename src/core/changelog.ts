...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "What I did lean into instead is trophies. Winning your league, winning the Continental Cup and winning the World Cup are all worth serious points now, and they stack. Winning your league is worth about ten league goals to a striker, the cup a bit more, the World Cup more again. I checked what this actually does over twenty seasons: the winner used to lift his own league 55% of the time, now it's 65%, he wins the Continental Cup 40% of the time, and in tournament years he's a World Cup winner about 40% of the time. That feels much closer to how the real award goes. It does mean the leading goalscorer sometimes loses out to someone who won two trophies, which is the point, and the winner's card shows you the full split so you can see exactly what he won it on.",
