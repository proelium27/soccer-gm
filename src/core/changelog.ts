...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Working out who's actually the best player in the world turned out to be the interesting part. Match ratings are scored against the league you play in, which means a 7.5 average in Portugal and a 7.5 in England look identical on paper even though one was earned against much easier opponents. If I'd just thrown everyone into one list, the trophy would have gone to the weakest league basically every year. So the world award adjusts for how strong each league actually is. It's a correction and not a punishment: a genuinely better player in France or Portugal still beats a merely good one in England, and I've watched enough seasons go by to be happy that the winners look right.",
      "The other half of it is that club football isn't the whole story. Goals and assists in the Continental Cup count, and so does your rating in it. The summer's international football counts too: goals, assists and caps, worth double in a World Cup year than in a qualifying one. One thing I had to be careful about was how much the cup itself was worth. My first pass had cup goals worth more than league ones on the theory that they're harder to come by, and that turned out to be flatly untrue: only the best attackers at the best twenty clubs play in the cup at all, so they score at about the same rate there as they do domestically. Twice out of eight seasons the trophy went to someone who'd had an average league season and a hot nine games. Nine games shouldn't outweigh thirty-eight, so I took that back out.",
      "What I did lean into instead is trophies. Winning your league, winning the Continental Cup and winning the World Cup are all worth serious points, and they stack. Winning your league is worth about ten league goals to a striker, the cup a bit more, the World Cup more again. The winner's card shows you the full split, so you can always see exactly what he won it on.",
      "The other thing I leaned on is just how good the player is. My first version handed it to whoever had the biggest goal tally a bit too readily: I ran twenty seasons and the typical winner was only around the 110th best player in the world, which isn't really what this trophy is supposed to mean. So the world award now weighs a player's overall rating a lot more heavily than your own league's Player of the Season does. That's not me being lazy and picking the highest-rated guy, there's a reason for it: every other number in the calculation has been scored against the standard of one league, so the rating is the only thing that means the same in England as it does in Portugal. After the change the typical winner is the 8th best player in the world, and something I didn't expect fell out of it, which is that strikers stopped hogging it. They used to win 75% of the time with literally no defender or holding midfielder ever making the top ten. Now it's 45%, attacking mids and wingers win a fair share, and I've seen a fullback win one.",
      "Worth saying plainly that those two things pull against each other, and I've balanced them on purpose rather than cranking both. When I turned the rating weight up, trophies mattered less; when I turned the trophy bonuses up to compensate, the rating effect vanished again. They're fighting over the same list. So the leading scorer won't always win it, a treble winner won't always win it, and the best player in the world won't always win it either. That's the intent.",
