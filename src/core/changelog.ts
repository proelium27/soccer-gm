...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "The other half of it is that club football isn't the whole story. Goals and assists in the Continental Cup count, your rating in it counts, and there's a bonus for how far your club went, biggest of all for winning it. I had the cup worth a lot more than that at first, and it was wrong: I ran a bunch of seasons and twice out of eight the trophy went to someone who'd had a distinctly average league season and just happened to go deep in the cup. Nine cup games shouldn't outweigh thirty-eight league ones, so now a big cup run settles a close race instead of overturning it. The summer's international football counts too: goals, assists and caps, worth double in a World Cup year, plus a bonus if your country actually lifted it. Winning your own league helps as well. The winner's card shows you the split, so you can see whether he won it on a monster league season or on the back of a cup run.",
