...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "One thing I like: squads are picked from the shape your players are in at the end of the club season, injuries and all. So if your star pulls up injured in May, he genuinely misses the tournament. It also plays out before anyone retires now, so a veteran in his last season gets one final shot at it. Caps, goals, tournaments and titles all build up on each player's profile over his career. To be clear, none of it feeds back into your club, it's purely there for the story of it. Might change that later, we'll see.",
