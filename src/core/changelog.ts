...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      "The chart on a player's profile plotted his OVR against the seasons he'd played. It now plots his transfer value instead, so the shape of a career reads the way it does on a real transfer-value chart: what the market thought he was worth, rising through his twenties and falling away after. The line is still colored by whichever club he was at, with club crests marking his transfers, and the axis starts at zero so a steady career isn't dressed up as a dramatic one. Above the chart sits his value today and, if it isn't now, the season he peaked and what he was worth then.",
      "Hovering a season used to show the club and the OVR. It now opens a card with his value that season, his OVR and POT, his goals and assists, his appearances, his average match rating, and the club, with a season he spent in a youth academy marked as such. A season he was in the squad for but never played reads as a dash rather than as zero goals.",
      ...
      "Because everything is worked back out of ratings already stored in the save, an existing league gets its full career charts immediately. The OVR chart is unchanged on retired players' profiles, where a market value would mean nothing.",
    ],
  },
  {
    date: "2026-08-12",
