...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  {
    date: "2026-07-25",
    title: "Found the actual cause of the transfers page freezing",
    items: [
      "I owe you a correction. I said earlier that the freezing was down to save files getting too big. That was a real problem and I did fix it, but it wasn't what was breaking the transfers page, and I should have been more careful before saying it was. Someone sent me their save and I could finally watch it happen.",
      "The culprit was the \"Completed This Window\" list at the bottom of the transfers page. It was drawing every single transfer in the window, and in a world of 240 clubs that's thousands. On the save I was sent it was trying to draw 2,056 rows, each with a little national flag next to it, which came to over 10,000 things on screen and about a megabyte of flag artwork. Some of those flags are enormously detailed files being shrunk down to 13 pixels tall, so your browser was doing a colossal amount of work to draw something you can barely see. That's what locked the whole page up, and it's why it was only ever the transfers page.",
      ...
      "Worth saying plainly: this had nothing to do with how long you'd been playing, so if the page was unusable for you it should just work now.",
    ],
  },
  {
    date: "2026-07-25",
    ...
    items: [
      "Separately from the transfers freeze above, saves were getting enormous, and the game rewrites the entire save every single time anything happens in it. By season 14 that file was 88 MB and writing it took seconds, which made everything feel sluggish the longer you played. (I originally thought this was what was breaking the transfers page. It wasn't, see the entry above, but it was well worth fixing on its own.)",
