...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Portuguese clubs earn slightly more than before, in every save. This is a knock-on effect of the world getting bigger rather than a change aimed at Portugal: with 320 clubs bidding in one shared transfer market instead of 240, fees rise for everyone, and Portugal was running the thinnest margin of any league. Testing a twenty-season save found a Portuguese club going into the red, which is not supposed to happen to any AI club, so Portugal's income was raised enough to restore its cushion.",
