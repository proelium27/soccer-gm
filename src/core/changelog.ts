...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Money does not follow the same order. Belgium is the poorest league in the game despite finishing above Turkey on the pitch: its clubs develop good players and sell them upward rather than keeping them. Turkey has more to spend than Belgium and still ranks below it, so it buys established players instead of producing them. This mirrors the real leagues, where the Belgian Pro League has the smallest combined squad value of the eight while ranking two places above Turkey in Europe.",
