...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "After the changes, across the same dynasties: 9-11% of players rated 78+ change club in a season, 2-5% of those moves are to a weaker squad, and $100M+ fees run about 5 per season across the whole world and go to players rated 80-86 rather than to 22-year-olds. The largest fee observed fell from $346M to $165-231M. Selling players brings in less than it used to, which is the intended trade: a nine-figure fee is meant to be a headline, not the going rate for a decent squad player.",
    ],
  },
  {
    date: "2026-08-07",
