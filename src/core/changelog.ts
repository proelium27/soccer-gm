...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      "Scouting is one of the most important sliders in the game and I had a feeling a lot of people were just never touching it, coasting on whatever they set once (or the default) forever. It quietly shapes how accurate every transfer value and potential read is all year, so ignoring it is a real handicap.",
