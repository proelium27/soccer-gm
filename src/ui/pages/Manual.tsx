      ...
      <div style={{ maxWidth: "56rem" }}>
        ...
        <Section id="pages" title="The Pages">
          ...
          <ul>
            ...
            <li><strong>Roster</strong> — your squad: your Starting XI on a pitch view (with an optional Depth Chart overlay), a stats table for the XI, and a bench table (both with ratings, ages, contracts, and season stats, and goalkeepers additionally show goals against and xG against). Drag a bench player onto a pitch slot to swap them into the XI, extend contracts, or release players.</li>
        ...
        <Section id="matches" title="The Match Engine">
          ...
          <ul>
            ...
            <li><strong>Passes, crosses & fouls</strong> — every box score also carries per-player passing (completed / attempted), crosses, and fouls committed. Central and deep players circulate the ball most; wide players do most of the crossing. These are descriptive stat-sheet detail — they don't change the scoreline.</li>
        ...
        <Section id="squad" title="Your Squad: Lineups, Depth & the Roster Cap">
          <p>
            ...
            player from the bench table onto a slot to swap them in, and the outgoing
            starter drops to the bench automatically. Click a chip to extend or release that
            player. Below the pitch is a <strong>stats table for your Starting XI</strong>, showing the same
