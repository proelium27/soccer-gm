      ...
      <div style={{ maxWidth: "56rem" }}>
        ...
        <Section id="squad" title="Your Squad: Lineups, Depth & the Roster Cap">
          <p>
            ...
            page — <strong>4-3-3</strong>, <strong>4-4-2</strong>, <strong>3-5-2</strong>, or{" "}
            <strong>5-3-2</strong>. It's a real tactical choice, not just a display: your team's
            ...
            can re-arrange from a sensible starting point. Only your club chooses a formation; every
            AI club plays 4-3-3. On
        ...
        <Section id="faq" title="FAQ & Known Quirks">
          ...
          <p><strong>Can I change formation?</strong> Yes — pick 4-3-3, 4-4-2, 3-5-2, or 5-3-2 from the dropdown above the pitch on the Roster page. It changes which eleven you field (and therefore your match strength), and resets your Starting XI to the best fit for the new shape. AI clubs always play 4-3-3.</p>
