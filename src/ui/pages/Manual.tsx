      ...
      <div style={{ maxWidth: "56rem" }}>
        ...
        <Section id="international" title="International Football">
          <p>
            ...
            <strong>continental championships</strong> are played: the European Championship, Copa
          ...
          <p>
            ...
            the semis, then the final, one click each, so you can watch it unfold. A continental
            summer works the same way, except every championship is played side by side: one click
            ...
            you'd rather not linger, "Sim through the World Cup" (or "the championships") plays the
          ...
          <p>
            The <strong>continental championships</strong> have no qualifying of their own: each
            confederation simply takes its strongest nations at the time of the draw, which is the
            order you see on Power Rankings. How big a championship is depends on how much football
            ...
            is thin. Fill it out — with an imported roster, say — and those championships start
          ...
          <p>
            ...
            and titles won show up on a player's profile and build over his career — continental
            championships are counted separately from World Cups, so winning the Euro doesn't read
          ...
          <p>
            ...
            Qualifying and Continental Cups tabs show the current campaign and let you flip back to
            past years (Continental Cups shows every championship of a given summer on one page);
        ...
        <Section id="matches" title="The Match Engine">
          ...
          <p>
            ...
            continental championship compared with a qualifier. A continental summer counts both the
            championship and that year's qualifying round. Your
          ...
          <p>
            ...
            winning your domestic cup, winning a continental championship and being in the squad
            ...
            a striker, a continental title about nine, winning your league about ten, the Continental
        ...
        <Section id="frivolities" title="Frivolities">
          ...
          <p>
            ...
            international goals, most caps, and most World Cups won. A player's caps and goals
            cover his whole international career, qualifying and World Cups together, the same
            numbers his profile shows. There's a country dropdown, which is what the tab is really
            for, since it answers who your country's all-time leading scorer is. Retired players
