      ...
      <div style={{ maxWidth: "56rem" }}>
        ...
        <Section id="pages" title="The Pages">
          ...
          <ul>
            ...
            <li><strong>Stat Leaders</strong> — a Players tab (league-wide leaderboards: goals, assists, shots, tackles, saves, clean sheets, minutes, and average match rating, with a season dropdown to view a single past season or "All Seasons" ranked by career totals or each player's single best season) and a Teams tab (the same stats plus possession, totaled per club for the season in progress — team totals reset each offseason, so past-season team leaderboards aren't browsable yet).</li>
