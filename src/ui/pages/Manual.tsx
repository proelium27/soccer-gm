      ...
      <div style={{ maxWidth: "56rem" }}>
        ...
        <Section id="pages" title="The Pages">
          ...
          <ul>
            ...
            <li><strong>News Feed</strong>. Transfers and player accomplishments woven into one timeline per season, with club and season filters, and your club's items highlighted. It's filtered by how much the story has to do with you, because the world is sixteen leagues across eight countries and reporting all of them equally buries you in news about clubs you'll never play. Your own club is always in, whatever it did &mdash; every transfer, loan, loan return and free signing, and every accomplishment. Your league is next: every deal (loans included) and every accomplishment in it. From the rest of the world you only get the big stories &mdash; a four-goal haul, a 100th career goal, a 35-goal season, the standout performance of the matchday, the Ballon d'Or, the World Team of the Year, Goalkeeper and Defender of the Year, and transfers over $40M. Accomplishments themselves are hat-tricks, one standout performance a matchday, career goal milestones at 50 and then every 50, season goal milestones at 25 and then every 5, and position changes for established players. <strong>End-of-season awards land in the feed too</strong>, at the bottom of the season they were won in: anything one of your players wins, plus your league's Player of the Season, Golden Boot and Team of the Season. Those come straight off the same record the Awards page reads, so old saves show every honour they ever handed out, right back to season 1. <strong>Countries winning and losing Continental Cup places</strong> land there too, in the same end-of-season block: when your country&apos;s coefficient moves it past another, the feed says so and shows which way the places went. Those are always reported, wherever they happen &mdash; a place changes hands well under once a season across the whole world, and when it does it changes the competition everyone plays in. Like the awards, they&apos;re worked out from the cups your save already has on record, so an old dynasty shows every place it ever won or lost. If one of your own players wins something, it's also the top item on your dashboard's news panel until the new season kicks off.</li>
