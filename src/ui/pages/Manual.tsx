      ...
      <div style={{ maxWidth: "56rem" }}>
        ...
        <Section id="pages" title="The Pages">
          ...
          <ul>
            ...
            <li><strong>Standings</strong> — the league table.</li>
            <li><strong>Schedule</strong> — every matchday's fixtures and results; click a played match for its box score.</li>
            <li><strong>Stat Leaders</strong> — league-wide leaderboards: goals, assists, shots, tackles, saves, clean sheets, minutes, and average match rating. Sortable.</li>
