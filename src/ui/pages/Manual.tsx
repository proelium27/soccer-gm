      ...
      <div style={{ maxWidth: "56rem" }}>
        ...
        <Section id="pages" title="The Pages">
          ...
          <ul>
            ...
            <li><strong>Frivolities</strong>. The fun-but-useless corner: all-time records (best and worst team seasons, highest rating ever reached, longest careers, biggest transfer fees), All-Time Leaders (any stat, career totals or best single seasons, world-wide and including retired players), player bios for everyone currently in the world (tallest, shortest, oldest, youngest, where players come from, name oddities), and club trivia (trophy cabinet, longest title droughts, biggest spenders and best traders, one-club men). More in <a href="#frivolities">Frivolities</a>.</li>
